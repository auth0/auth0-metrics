(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/index.js":[function(require,module,exports){var debug=require("debug")("auth0-metrics");var _=require("lodash");module.exports=Auth0Metrics;function Auth0Metrics(segmentKey,dwhEndpoint,label){if(!(this instanceof Auth0Metrics)){return new Auth0Metrics(segmentKey,dwhEndpoint,label)}if("string"!==typeof segmentKey)throw new Error("`segmentKey` required as first parameter.");if("string"!==typeof dwhEndpoint)throw new Error("`dwhEndpoint` required as first parameter.");this.$options={};this.$options.segmentKey=segmentKey;this.$options.dwhEndpoint=dwhEndpoint;this.$options.label=label;debug("Loading DWH endpoint library...");this.dwh=require("./lib/dwh")(dwhEndpoint,label);debug("Loading segment...");this._segment=require("./lib/boot-segment")(segmentKey)}Auth0Metrics.version="1.0.0";Auth0Metrics.prototype.segment=function(){return this._segment};Auth0Metrics.prototype.track=function(name,data,callback){var segment=this.segment();if(!segment.loaded){debug("track call without segment")}try{segment.track.call(segment,name,_.assign({},this.getData(),data||{}),null)}catch(error){debug("segment analytics error: %o",error)}try{this.dwh.track(name,data,callback)}catch(error){debug("dwh analytics error: %o",error)}};Auth0Metrics.prototype.setUserId=function(uid,override){var segment=this.segment();if(!segment.loaded)return;try{var aid=segment.user().anonymousId();segment.user().id(uid);segment.user().anonymousId(aid)}catch(error){console.error("segment error: %o",error)}};Auth0Metrics.prototype.identify=function(id,traits,callback){var segment=this.segment();if(typeof id!=="string"){traits=id;id=null}if(segment.loaded){if(null!=id){this.setUserId(id);try{segment.identify(id,traits)}catch(error){debug("segment analytics error: %o",error)}}}else{debug("identify call without segment")}try{this.dwh.identify(id,traits,callback)}catch(error){debug("dwh analytics error: %o",error)}};Auth0Metrics.prototype.alias=function(userId,callback){var segment=this.segment();if(!segment.loaded){debug("alias call without segment")}try{segment.alias.apply(segment,arguments)}catch(error){debug("segment analytics error: %o",error)}try{this.dwh.alias(userId,callback)}catch(error){debug("dwh analytics error: %o",error)}};Auth0Metrics.prototype.page=function(callback){var segment=this.segment();if(!segment.loaded){debug("track call without segment")}try{segment.page.apply(segment,arguments)}catch(error){debug("segment analytics error: %o",error)}try{this.dwh.page(callback)}catch(error){debug("dwh analytics error: %o",error)}};Auth0Metrics.prototype.traits=function(){return this.dwh.traits()};Auth0Metrics.prototype.getData=function(){return{path:window.location.pathname,url:window.location.toString(),title:document.title,referrer:document.referrer,search:window.location.search,label:this.$options.label}};Auth0Metrics.prototype.ready=function(cb){var segment=this.segment();if(!segment.loaded){return cb(new Error("no segment integration on page"))}segment.ready(onready(1e3));function onready(timeout){var timer=setTimeout(function(){debug("segment timeout, continuing with page load anyways");cb(new Error("segment timeout, continuing with page load anyways"));timer=null},timeout);return function onanalyticsready(){if(!timer){return debug("stop segment.ready execution fired too late")}debug("segment integration ready!");clearTimeout(timer);timer=null;cb()}}}},{"./lib/boot-segment":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/boot-segment/index.js","./lib/dwh":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/index.js",debug:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js",lodash:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/lodash/index.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/boot-segment/index.js":[function(require,module,exports){var debug=require("debug")("auth0-metrics:boot-segment");module.exports=bootSegment;function bootSegment(segmentKey){var analytics=window.analytics=[];analytics.invoked=true;analytics.loaded=false;analytics.methods=["trackSubmit","trackClick","trackLink","trackForm","pageview","identify","group","track","ready","alias","page","once","off","on"];analytics.factory=function(method){return function(){var args=Array.prototype.slice.call(arguments);args.unshift(method);analytics.push(args);debug("Called segment method without segment loaded",method);return analytics}};for(var i=0;i<analytics.methods.length;i++){var key=analytics.methods[i];analytics[key]=analytics.factory(key)}analytics.load=function(key){var script=document.createElement("script");script.type="text/javascript";script.async=true;script.src=("https:"===document.location.protocol?"https://":"http://")+"cdn.segment.com/analytics.js/v1/"+key+"/analytics.min.js";script.onerror=function(){debug("Segment load failed")};script.onload=function(){debug("Finished loading segment");analytics=window.analytics;analytics.loaded=true};var first=document.getElementsByTagName("script")[0];first.parentNode.insertBefore(script,first)};analytics.SNIPPET_VERSION="3.0.1";if(segmentKey===""){debug("empty segmentKey passed, segment methods will be mocked")}else{analytics.load(segmentKey)}return analytics}},{debug:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/cookie.js":[function(require,module,exports){var _=require("lodash");var cookie=require("component-cookie");var debug=require("debug")("auth0-metrics:dwh:cookie");var defaults=require("stluafed");var parse=require("component-url").parse;var levelsUrl=function(url){var host=parse(url).hostname;var parts=host.split(".");var last=parts[parts.length-1];var levels=[];if(4==parts.length&&parseInt(last,10)==last){return levels}if(1>=parts.length){return levels}for(var i=parts.length-2;0<=i;--i){levels.push(parts.slice(i).join("."))}return levels};var topDomain=function(url){var levels=levelsUrl(url);for(var i=0;i<levels.length;++i){var cname="__tld__";var domain=levels[i];var opts={domain:"."+domain};cookie(cname,1,opts);if(cookie(cname)){cookie(cname,null,opts);return domain}}return""};function Cookie(options){if(!(this instanceof Cookie)){return new Cookie(options)}this.options(options)}Cookie.prototype.options=function(options){if(arguments.length===0)return this._options;options=options||{};var domain="."+topDomain(window.location.href);if(domain===".")domain=null;this._options=defaults(options,{maxage:31536e6,path:"/",domain:domain});this.set("ajs:test",true);if(!this.get("ajs:test")){debug("fallback to domain=null");this._options.domain=null}this.remove("ajs:test")};Cookie.prototype.set=function(key,value){try{value=JSON.stringify(value);cookie(key,value,_.assign(true,{},this._options));return true}catch(e){return false}};Cookie.prototype.get=function(key){try{var value=cookie(key);value=value?JSON.parse(value):null;return value}catch(e){return null}};Cookie.prototype.remove=function(key){try{cookie(key,null,_.assign(true,{},this._options));return true}catch(e){return false}};module.exports=Cookie},{"component-cookie":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/component-cookie/index.js","component-url":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/component-url/index.js",debug:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js",lodash:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/lodash/index.js",stluafed:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/stluafed/index.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/index.js":[function(require,module,exports){var _=require("lodash");var request=require("superagent");var uuid=require("uuid");var cookie=require("./cookie")();var store=require("./store")();var memory=require("./memory")();var debug=require("debug")("auth0-metrics:dwh");module.exports=dwh;function dwh(url,label){if(!(this instanceof dwh)){return new dwh(url,label)}debug("Initializing DWH with parameters ",url,label);this.url=url;this.label=label;cookie.set("ajs:cookies",true);if(cookie.get("ajs:cookies")){cookie.remove("ajs:cookies");this._storage=cookie;this.storageType="cookie";return}if(store.enabled){this._storage=store;this.storageType="localStorage";return}debug("warning using memory store both cookies and localStorage are disabled");this._storage=memory;this.storageType="memory"}dwh.prototype.anonymousId=function(anonymousId){var store=this._storage;if(arguments.length){store.set("ajs_anonymous_id",anonymousId);return this}anonymousId=store.get("ajs_anonymous_id");if(anonymousId){return anonymousId}anonymousId=uuid();store.set("ajs_anonymous_id",anonymousId);return store.get("ajs_anonymous_id")};dwh.prototype.userid=function(userid){var store=this._storage;if(arguments.length){store.set("ajs_user_id",userid);return this}return store.get("ajs_user_id")};dwh.prototype.traits=function(newTraits){if(arguments.length){store.set("ajs_user_traits",newTraits);return this}return store.get("ajs_user_traits")};dwh.prototype.annexData=function(data){data.sentAt=(new Date).getTime();data.userAgent=navigator.userAgent;data.messageId=uuid();data.anonymousId=this.anonymousId();data.storageType=this.storageType;data.path=window.location.pathname;data.url=window.location.toString();data.title=document.title;data.referrer=document.referrer;data.search=window.location.search;data.label=this.label;return data};dwh.prototype.genericRequest=function(url,type,data,callback){var data=this.annexData(data);debug("Sending request to DWH: ",type,data);request.post(url).send(JSON.stringify({type:type,data:data})).set("Content-Type","application/json").set("Accept","application/json").end(callback)};dwh.prototype.track=function(event,data,callback){this.genericRequest(this.url,"track",{userId:this.userid(),event:event,properties:data},callback)};dwh.prototype.page=function(callback){this.genericRequest(this.url,"page",{userId:this.userid()},callback)};dwh.prototype.identify=function(id,traits,callback){var newId=id;if(newId==null){newId=this.userid()}else{this.userid(newId)}var newTraits=_.assign({},this.traits(),traits);this.traits(newTraits);this.genericRequest(this.url,"identify",{userId:newId,traits:newTraits},callback)};dwh.prototype.alias=function(id,callback){var newId=id;if(newId==null){return}var oldId=this.userid();this.userid(newId);this.genericRequest(this.url,"alias",{previousId:oldId,userId:newId},callback)}},{"./cookie":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/cookie.js","./memory":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/memory.js","./store":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/store.js",debug:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js",lodash:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/lodash/index.js",superagent:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/superagent/lib/client.js",uuid:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/uuid/uuid.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/memory.js":[function(require,module,exports){var _=require("lodash");var has=Object.prototype.hasOwnProperty;module.exports=Memory;function Memory(){if(!(this instanceof Memory)){return new Memory}this.store={}}Memory.prototype.set=function(key,value){this.store[key]=_.assign(true,{},value);return true};Memory.prototype.get=function(key){if(!has.call(this.store,key))return;return _.assign(true,{},this.store[key])};Memory.prototype.remove=function(key){delete this.store[key];return true}},{lodash:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/lodash/index.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/lib/dwh/store.js":[function(require,module,exports){var defaults=require("stluafed");var store=require("store");function Store(options){if(!(this instanceof Store)){return new Store(options)}this.options(options)}Store.prototype.options=function(options){if(arguments.length===0)return this._options;options=options||{};defaults(options,{enabled:true});this.enabled=options.enabled&&store.enabled;this._options=options};Store.prototype.set=function(key,value){if(!this.enabled)return false;return store.set(key,value)};Store.prototype.get=function(key){if(!this.enabled)return null;return store.get(key)};Store.prototype.remove=function(key){if(!this.enabled)return false;return store.remove(key)};module.exports=Store},{stluafed:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/stluafed/index.js",store:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/store/store.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/component-cookie/index.js":[function(require,module,exports){var debug=require("debug")("cookie");module.exports=function(name,value,options){switch(arguments.length){case 3:case 2:return set(name,value,options);case 1:return get(name);default:return all()}};function set(name,value,options){options=options||{};var str=encode(name)+"="+encode(value);if(null==value)options.maxage=-1;if(options.maxage){options.expires=new Date(+new Date+options.maxage)}if(options.path)str+="; path="+options.path;if(options.domain)str+="; domain="+options.domain;if(options.expires)str+="; expires="+options.expires.toUTCString();if(options.secure)str+="; secure";document.cookie=str}function all(){var str;try{str=document.cookie}catch(err){if(typeof console!=="undefined"&&typeof console.error==="function"){console.error(err.stack||err)}return{}}return parse(str)}function get(name){return all()[name]}function parse(str){var obj={};var pairs=str.split(/ *; */);var pair;if(""==pairs[0])return obj;for(var i=0;i<pairs.length;++i){pair=pairs[i].split("=");obj[decode(pair[0])]=decode(pair[1])}return obj}function encode(value){try{return encodeURIComponent(value)}catch(e){debug("error `encode(%o)` - %o",value,e)}}function decode(value){try{return decodeURIComponent(value)}catch(e){debug("error `decode(%o)` - %o",value,e)}}},{debug:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/component-url/index.js":[function(require,module,exports){exports.parse=function(url){var a=document.createElement("a");a.href=url;return{href:a.href,host:a.host||location.host,port:"0"===a.port||""===a.port?port(a.protocol):a.port,hash:a.hash,hostname:a.hostname||location.hostname,pathname:a.pathname.charAt(0)!="/"?"/"+a.pathname:a.pathname,protocol:!a.protocol||":"==a.protocol?location.protocol:a.protocol,search:a.search,query:a.search.slice(1)}};exports.isAbsolute=function(url){return 0==url.indexOf("//")||!!~url.indexOf("://")};exports.isRelative=function(url){return!exports.isAbsolute(url)};exports.isCrossDomain=function(url){url=exports.parse(url);var location=exports.parse(window.location.href);return url.hostname!==location.hostname||url.port!==location.port||url.protocol!==location.protocol};function port(protocol){switch(protocol){case"http:":return 80;case"https:":return 443;default:return location.port}}},{}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/browser.js":[function(require,module,exports){exports=module.exports=require("./debug");exports.log=log;exports.formatArgs=formatArgs;exports.save=save;exports.load=load;exports.useColors=useColors;exports.storage="undefined"!=typeof chrome&&"undefined"!=typeof chrome.storage?chrome.storage.local:localstorage();exports.colors=["lightseagreen","forestgreen","goldenrod","dodgerblue","darkorchid","crimson"];function useColors(){return"WebkitAppearance"in document.documentElement.style||window.console&&(console.firebug||console.exception&&console.table)||navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/)&&parseInt(RegExp.$1,10)>=31}exports.formatters.j=function(v){return JSON.stringify(v)};function formatArgs(){var args=arguments;var useColors=this.useColors;args[0]=(useColors?"%c":"")+this.namespace+(useColors?" %c":" ")+args[0]+(useColors?"%c ":" ")+"+"+exports.humanize(this.diff);if(!useColors)return args;var c="color: "+this.color;args=[args[0],c,"color: inherit"].concat(Array.prototype.slice.call(args,1));var index=0;var lastC=0;args[0].replace(/%[a-z%]/g,function(match){if("%%"===match)return;index++;if("%c"===match){lastC=index}});args.splice(lastC,0,c);return args}function log(){return"object"===typeof console&&console.log&&Function.prototype.apply.call(console.log,console,arguments)}function save(namespaces){try{if(null==namespaces){exports.storage.removeItem("debug")}else{exports.storage.debug=namespaces}}catch(e){}}function load(){var r;try{r=exports.storage.debug}catch(e){}return r}exports.enable(load());function localstorage(){try{return window.localStorage}catch(e){}}},{"./debug":"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/debug.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/debug.js":[function(require,module,exports){exports=module.exports=debug;exports.coerce=coerce;exports.disable=disable;exports.enable=enable;exports.enabled=enabled;exports.humanize=require("ms");exports.names=[];exports.skips=[];exports.formatters={};var prevColor=0;var prevTime;function selectColor(){return exports.colors[prevColor++%exports.colors.length]}function debug(namespace){function disabled(){}disabled.enabled=false;function enabled(){var self=enabled;var curr=+new Date;var ms=curr-(prevTime||curr);self.diff=ms;self.prev=prevTime;self.curr=curr;prevTime=curr;if(null==self.useColors)self.useColors=exports.useColors();if(null==self.color&&self.useColors)self.color=selectColor();var args=Array.prototype.slice.call(arguments);args[0]=exports.coerce(args[0]);if("string"!==typeof args[0]){args=["%o"].concat(args)}var index=0;args[0]=args[0].replace(/%([a-z%])/g,function(match,format){if(match==="%%")return match;index++;var formatter=exports.formatters[format];if("function"===typeof formatter){var val=args[index];match=formatter.call(self,val);args.splice(index,1);index--}return match});if("function"===typeof exports.formatArgs){args=exports.formatArgs.apply(self,args)}var logFn=enabled.log||exports.log||console.log.bind(console);logFn.apply(self,args)}enabled.enabled=true;var fn=exports.enabled(namespace)?enabled:disabled;fn.namespace=namespace;return fn}function enable(namespaces){exports.save(namespaces);var split=(namespaces||"").split(/[\s,]+/);var len=split.length;for(var i=0;i<len;i++){if(!split[i])continue;namespaces=split[i].replace(/\*/g,".*?");if(namespaces[0]==="-"){exports.skips.push(new RegExp("^"+namespaces.substr(1)+"$"))}else{exports.names.push(new RegExp("^"+namespaces+"$"))}}}function disable(){exports.enable("")}function enabled(name){var i,len;for(i=0,len=exports.skips.length;i<len;i++){if(exports.skips[i].test(name)){return false}}for(i=0,len=exports.names.length;i<len;i++){if(exports.names[i].test(name)){return true}}return false}function coerce(val){if(val instanceof Error)return val.stack||val.message;return val}},{ms:"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/node_modules/ms/index.js"}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/debug/node_modules/ms/index.js":[function(require,module,exports){var s=1e3;var m=s*60;var h=m*60;var d=h*24;var y=d*365.25;module.exports=function(val,options){options=options||{};if("string"==typeof val)return parse(val);return options.long?long(val):short(val)};function parse(str){str=""+str;if(str.length>1e4)return;var match=/^((?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|years?|yrs?|y)?$/i.exec(str);if(!match)return;var n=parseFloat(match[1]);var type=(match[2]||"ms").toLowerCase();switch(type){case"years":case"year":case"yrs":case"yr":case"y":return n*y;case"days":case"day":case"d":return n*d;case"hours":case"hour":case"hrs":case"hr":case"h":return n*h;case"minutes":case"minute":case"mins":case"min":case"m":return n*m;case"seconds":case"second":case"secs":case"sec":case"s":return n*s;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return n}}function short(ms){if(ms>=d)return Math.round(ms/d)+"d";if(ms>=h)return Math.round(ms/h)+"h";if(ms>=m)return Math.round(ms/m)+"m";if(ms>=s)return Math.round(ms/s)+"s";return ms+"ms"}function long(ms){return plural(ms,d,"day")||plural(ms,h,"hour")||plural(ms,m,"minute")||plural(ms,s,"second")||ms+" ms"}function plural(ms,n,name){if(ms<n)return;if(ms<n*1.5)return Math.floor(ms/n)+" "+name;return Math.ceil(ms/n)+" "+name+"s"}},{}],"/home/ubuntu/.strider/data/auth0-auth0-metrics-55ca4cd2fc41f46635a2f510/node_modules/lodash/index.js":[function(require,module,exports){(function(global){(function(){var undefined;var VERSION="3.10.1";var BIND_FLAG=1,BIND_KEY_FLAG=2,CURRY_BOUND_FLAG=4,CURRY_FLAG=8,CURRY_RIGHT_FLAG=16,PARTIAL_FLAG=32,PARTIAL_RIGHT_FLAG=64,ARY_FLAG=128,REARG_FLAG=256;var DEFAULT_TRUNC_LENGTH=30,DEFAULT_TRUNC_OMISSION="...";var HOT_COUNT=150,HOT_SPAN=16;var LARGE_ARRAY_SIZE=200;var LAZY_FILTER_FLAG=1,LAZY_MAP_FLAG=2;var FUNC_ERROR_TEXT="Expected a function";var PLACEHOLDER="__lodash_placeholder__";var argsTag="[object Arguments]",arrayTag="[object Array]",boolTag="[object Boolean]",dateTag="[object Date]",errorTag="[object Error]",funcTag="[object Function]",mapTag="[object Map]",numberTag="[object Number]",objectTag="[object Object]",regexpTag="[object RegExp]",setTag="[object Set]",stringTag="[object String]",weakMapTag="[object WeakMap]";var arrayBufferTag="[object ArrayBuffer]",float32Tag="[object Float32Array]",float64Tag="[object Float64Array]",int8Tag="[object Int8Array]",int16Tag="[object Int16Array]",int32Tag="[object Int32Array]",uint8Tag="[object Uint8Array]",uint8ClampedTag="[object Uint8ClampedArray]",uint16Tag="[object Uint16Array]",uint32Tag="[object Uint32Array]";var reEmptyStringLeading=/\b__p \+= '';/g,reEmptyStringMiddle=/\b(__p \+=) '' \+/g,reEmptyStringTrailing=/(__e\(.*?\)|\b__t\)) \+\n'';/g;var reEscapedHtml=/&(?:amp|lt|gt|quot|#39|#96);/g,reUnescapedHtml=/[&<>"'`]/g,reHasEscapedHtml=RegExp(reEscapedHtml.source),reHasUnescapedHtml=RegExp(reUnescapedHtml.source);var reEscape=/<%-([\s\S]+?)%>/g,reEvaluate=/<%([\s\S]+?)%>/g,reInterpolate=/<%=([\s\S]+?)%>/g;var reIsDeepProp=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,reIsPlainProp=/^\w*$/,rePropName=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\n\\]|\\.)*?)\2)\]/g;var reRegExpChars=/^[:!,]|[\\^$.*+?()[\]{}|\/]|(^[0-9a-fA-Fnrtuvx])|([\n\r\u2028\u2029])/g,reHasRegExpChars=RegExp(reRegExpChars.source);var reComboMark=/[\u0300-\u036f\ufe20-\ufe23]/g;var reEscapeChar=/\\(\\)?/g;var reEsTemplate=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;var reFlags=/\w*$/;var reHasHexPrefix=/^0[xX]/;var reIsHostCtor=/^\[object .+?Constructor\]$/;var reIsUint=/^\d+$/;var reLatin1=/[\xc0-\xd6\xd8-\xde\xdf-\xf6\xf8-\xff]/g;var reNoMatch=/($^)/;var reUnescapedString=/['\n\r\u2028\u2029\\]/g;var reWords=function(){var upper="[A-Z\\xc0-\\xd6\\xd8-\\xde]",lower="[a-z\\xdf-\\xf6\\xf8-\\xff]+";return RegExp(upper+"+(?="+upper+lower+")|"+upper+"?"+lower+"|"+upper+"+|[0-9]+","g")}();var contextProps=["Array","ArrayBuffer","Date","Error","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Math","Number","Object","RegExp","Set","String","_","clearTimeout","isFinite","parseFloat","parseInt","setTimeout","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","WeakMap"];var templateCounter=-1;var typedArrayTags={};typedArrayTags[float32Tag]=typedArrayTags[float64Tag]=typedArrayTags[int8Tag]=typedArrayTags[int16Tag]=typedArrayTags[int32Tag]=typedArrayTags[uint8Tag]=typedArrayTags[uint8ClampedTag]=typedArrayTags[uint16Tag]=typedArrayTags[uint32Tag]=true;typedArrayTags[argsTag]=typedArrayTags[arrayTag]=typedArrayTags[arrayBufferTag]=typedArrayTags[boolTag]=typedArrayTags[dateTag]=typedArrayTags[errorTag]=typedArrayTags[funcTag]=typedArrayTags[mapTag]=typedArrayTags[numberTag]=typedArrayTags[objectTag]=typedArrayTags[regexpTag]=typedArrayTags[setTag]=typedArrayTags[stringTag]=typedArrayTags[weakMapTag]=false;var cloneableTags={};cloneableTags[argsTag]=cloneableTags[arrayTag]=cloneableTags[arrayBufferTag]=cloneableTags[boolTag]=cloneableTags[dateTag]=cloneableTags[float32Tag]=cloneableTags[float64Tag]=cloneableTags[int8Tag]=cloneableTags[int16Tag]=cloneableTags[int32Tag]=cloneableTags[numberTag]=cloneableTags[objectTag]=cloneableTags[regexpTag]=cloneableTags[stringTag]=cloneableTags[uint8Tag]=cloneableTags[uint8ClampedTag]=cloneableTags[uint16Tag]=cloneableTags[uint32Tag]=true;cloneableTags[errorTag]=cloneableTags[funcTag]=cloneableTags[mapTag]=cloneableTags[setTag]=cloneableTags[weakMapTag]=false;var deburredLetters={"\xc0":"A","\xc1":"A","\xc2":"A","\xc3":"A","\xc4":"A","\xc5":"A","\xe0":"a","\xe1":"a","\xe2":"a","\xe3":"a","\xe4":"a","\xe5":"a","\xc7":"C","\xe7":"c","\xd0":"D","\xf0":"d","\xc8":"E","\xc9":"E","\xca":"E","\xcb":"E","\xe8":"e","\xe9":"e","\xea":"e","\xeb":"e","\xcc":"I","\xcd":"I","\xce":"I","\xcf":"I","\xec":"i","\xed":"i","\xee":"i","\xef":"i","\xd1":"N","\xf1":"n","\xd2":"O","\xd3":"O","\xd4":"O","\xd5":"O","\xd6":"O","\xd8":"O","\xf2":"o","\xf3":"o","\xf4":"o","\xf5":"o","\xf6":"o","\xf8":"o","\xd9":"U","\xda":"U","\xdb":"U","\xdc":"U","\xf9":"u","\xfa":"u","\xfb":"u","\xfc":"u","\xdd":"Y","\xfd":"y","\xff":"y","\xc6":"Ae","\xe6":"ae","\xde":"Th","\xfe":"th","\xdf":"ss"};var htmlEscapes={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#96;"};var htmlUnescapes={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"',"&#39;":"'","&#96;":"`"};var objectTypes={"function":true,object:true};var regexpEscapes={0:"x30",1:"x31",2:"x32",3:"x33",4:"x34",5:"x35",6:"x36",7:"x37",8:"x38",9:"x39",A:"x41",B:"x42",C:"x43",D:"x44",E:"x45",F:"x46",a:"x61",b:"x62",c:"x63",d:"x64",e:"x65",f:"x66",n:"x6e",r:"x72",t:"x74",u:"x75",v:"x76",x:"x78"};var stringEscapes={"\\":"\\","'":"'","\n":"n","\r":"r","\u2028":"u2028","\u2029":"u2029"};var freeExports=objectTypes[typeof exports]&&exports&&!exports.nodeType&&exports;var freeModule=objectTypes[typeof module]&&module&&!module.nodeType&&module;var freeGlobal=freeExports&&freeModule&&typeof global=="object"&&global&&global.Object&&global;var freeSelf=objectTypes[typeof self]&&self&&self.Object&&self;var freeWindow=objectTypes[typeof window]&&window&&window.Object&&window;var moduleExports=freeModule&&freeModule.exports===freeExports&&freeExports;var root=freeGlobal||freeWindow!==(this&&this.window)&&freeWindow||freeSelf||this;function baseCompareAscending(value,other){if(value!==other){var valIsNull=value===null,valIsUndef=value===undefined,valIsReflexive=value===value;var othIsNull=other===null,othIsUndef=other===undefined,othIsReflexive=other===other;if(value>other&&!othIsNull||!valIsReflexive||valIsNull&&!othIsUndef&&othIsReflexive||valIsUndef&&othIsReflexive){return 1}if(value<other&&!valIsNull||!othIsReflexive||othIsNull&&!valIsUndef&&valIsReflexive||othIsUndef&&valIsReflexive){return-1}}return 0}function baseFindIndex(array,predicate,fromRight){var length=array.length,index=fromRight?length:-1;while(fromRight?index--:++index<length){if(predicate(array[index],index,array)){return index}}return-1}function baseIndexOf(array,value,fromIndex){if(value!==value){return indexOfNaN(array,fromIndex)}var index=fromIndex-1,length=array.length;while(++index<length){if(array[index]===value){return index}}return-1}function baseIsFunction(value){return typeof value=="function"||false}function baseToString(value){return value==null?"":value+""}function charsLeftIndex(string,chars){var index=-1,length=string.length;while(++index<length&&chars.indexOf(string.charAt(index))>-1){}return index}function charsRightIndex(string,chars){var index=string.length;while(index--&&chars.indexOf(string.charAt(index))>-1){}return index}function compareAscending(object,other){return baseCompareAscending(object.criteria,other.criteria)||object.index-other.index}function compareMultiple(object,other,orders){var index=-1,objCriteria=object.criteria,othCriteria=other.criteria,length=objCriteria.length,ordersLength=orders.length;while(++index<length){var result=baseCompareAscending(objCriteria[index],othCriteria[index]);if(result){if(index>=ordersLength){return result}var order=orders[index];return result*(order==="asc"||order===true?1:-1)}}return object.index-other.index}function deburrLetter(letter){return deburredLetters[letter]}function escapeHtmlChar(chr){return htmlEscapes[chr]}function escapeRegExpChar(chr,leadingChar,whitespaceChar){if(leadingChar){chr=regexpEscapes[chr]}else if(whitespaceChar){chr=stringEscapes[chr]}return"\\"+chr}function escapeStringChar(chr){return"\\"+stringEscapes[chr]}function indexOfNaN(array,fromIndex,fromRight){var length=array.length,index=fromIndex+(fromRight?0:-1);while(fromRight?index--:++index<length){var other=array[index];if(other!==other){return index}}return-1}function isObjectLike(value){return!!value&&typeof value=="object"}function isSpace(charCode){return charCode<=160&&(charCode>=9&&charCode<=13)||charCode==32||charCode==160||charCode==5760||charCode==6158||charCode>=8192&&(charCode<=8202||charCode==8232||charCode==8233||charCode==8239||charCode==8287||charCode==12288||charCode==65279)}function replaceHolders(array,placeholder){var index=-1,length=array.length,resIndex=-1,result=[];while(++index<length){if(array[index]===placeholder){array[index]=PLACEHOLDER;result[++resIndex]=index}}return result}function sortedUniq(array,iteratee){var seen,index=-1,length=array.length,resIndex=-1,result=[];while(++index<length){var value=array[index],computed=iteratee?iteratee(value,index,array):value;if(!index||seen!==computed){seen=computed;result[++resIndex]=value}}return result}function trimmedLeftIndex(string){var index=-1,length=string.length;while(++index<length&&isSpace(string.charCodeAt(index))){}return index}function trimmedRightIndex(string){var index=string.length;while(index--&&isSpace(string.charCodeAt(index))){}return index}function unescapeHtmlChar(chr){return htmlUnescapes[chr]}function runInContext(context){context=context?_.defaults(root.Object(),context,_.pick(root,contextProps)):root;var Array=context.Array,Date=context.Date,Error=context.Error,Function=context.Function,Math=context.Math,Number=context.Number,Object=context.Object,RegExp=context.RegExp,String=context.String,TypeError=context.TypeError;var arrayProto=Array.prototype,objectProto=Object.prototype,stringProto=String.prototype;var fnToString=Function.prototype.toString;var hasOwnProperty=objectProto.hasOwnProperty;var idCounter=0;var objToString=objectProto.toString;var oldDash=root._;var reIsNative=RegExp("^"+fnToString.call(hasOwnProperty).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");
